  ...
  return (
    ...
    >
      <mesh rotation={[Math.PI / 2, 0, 0]}>
        <torusGeometry args={[0.3, 0.105, 10, 28]} />
        <meshStandardMaterial
          color={c.charcoal}
          roughness={0.9}
        />
      ...
      <mesh>
        <cylinderGeometry args={[0.215, 0.215, 0.18, 24]} />
        <meshStandardMaterial
          color={c.cream}
          roughness={0.8}
        />
  ...
  return (
    <>
      ...
      <mesh position={[0, -0.04, 0]}>
        <cylinderGeometry args={[1.95, 2, 0.12, 64]} />
        <meshStandardMaterial
          color={c.platform}
          roughness={1}
        />
      ...
      <group ref={scooter}>
        ...
        <Wheel x={0.92} />
        <Block
          position={[-0.67, 0.81, 0]}
          scale={[0.95, 0.57, 0.55]}
          color={c.clay}
        />
        <Block
          position={[0.15, 0.6, 0]}
          scale={[1.25, 0.12, 0.49]}
          color={c.clay}
        />
        <Block
          position={[0.75, 1, 0]}
          scale={[0.22, 0.85, 0.49]}
          rotation={[0, 0, -0.15]}
          color={c.clay}
        />
        <Block
        ...
        />
        <Block
          position={[0.72, 1.57, 0]}
          scale={[0.14, 0.45, 0.13]}
          rotation={[0, 0, 0.25]}
          color={c.charcoal}
        />
        <Block
        ...
        />
        <mesh
          position={[0.83, 1.55, 0]}
          rotation={[0, 0, Math.PI / 2]}
        >
          <cylinderGeometry args={[0.17, 0.19, 0.18, 24]} />
          <meshStandardMaterial color={c.cream} />
        </mesh>
        <Block
          position={[-1.05, 1.25, 0]}
          scale={[0.65, 0.08, 0.63]}
          color={c.sage}
        />
        {[1.42, 1.64, 1.86].map((y) => (
          <mesh
            key={y}
            position={[-1.04, y, 0]}
          >
            <cylinderGeometry args={[0.3, 0.3, 0.19, 24]} />
            <meshStandardMaterial
              color={c.cream}
              roughness={0.65}
            />
        ...
        <Block
          position={[-1.04, 1.64, 0.3]}
          scale={[0.09, 0.65, 0.045]}
          color={c.sage}
        />
        <Block
          position={[-1.04, 1.98, 0]}
          scale={[0.36, 0.06, 0.1]}
          color={c.sage}
        />
      </group>
      <group
        ref={pin}
        position={[1.18, 1.15, -0.95]}
      >
        <mesh>
          <sphereGeometry args={[0.22, 20, 14]} />
          <meshStandardMaterial color={mode === 'pending' ? c.sage : c.clay} />
        </mesh>
        <mesh
          position={[0, -0.23, 0]}
        ...
        >
          ...
          <meshStandardMaterial color={c.clay} />
        </mesh>
      </group>
      <mesh
        rotation={[-Math.PI / 2, 0, 0]}
        position={[0.7, 0.035, -0.55]}
      >
        <torusGeometry args={[0.72, 0.025, 6, 32, Math.PI * 1.4]} />
