...
const PLANS = [
  {
    ...
    code: 'WEEKDAY_LUNCH_VEG',
    name: 'Weekday Lunch (Veg)',
    slot: 'LUNCH',
    price: 12000,
  },
  {
    id: '11111111-0000-4000-8000-000000000002',
    code: 'WEEKDAY_LUNCH_NONVEG',
    name: 'Weekday Lunch (Non-veg)',
    slot: 'LUNCH',
    price: 15000,
  },
  {
    id: '11111111-0000-4000-8000-000000000003',
    code: 'ALLDAY_LUNCH_VEG',
    name: 'All-week Lunch (Veg)',
    slot: 'LUNCH',
    price: 14000,
  },
];
...
const CUSTOMERS = [
  {
    ...
    name: 'Asha Rao',
    phone: '+919810000001',
    address: 'B-402, Sector 62, Noida 201301',
  },
  {
    id: '22222222-0000-4000-8000-000000000002',
    name: 'Imran Sheikh',
    phone: '+919810000002',
    address: 'C-11, Indirapuram, Ghaziabad 201014',
  },
  {
    id: '22222222-0000-4000-8000-000000000003',
    name: 'Priya Nair',
    phone: '+919810000003',
    address: 'A-7, Alpha 1, Greater Noida 201310',
  },
  {
    id: '22222222-0000-4000-8000-000000000004',
    name: 'Rohan Gupta',
    phone: '+919810000004',
    address: 'D-19, Sector 18, Noida 201301',
  },
  {
    id: '22222222-0000-4000-8000-000000000005',
    name: 'Meera Iyer',
    phone: '+919810000005',
    address: 'F-3, Vaishali, Ghaziabad 201010',
  },
  {
    id: '22222222-0000-4000-8000-000000000006',
    name: 'Karan Mehta',
    phone: '+919810000006',
    address: 'G-22, Sector 15, Noida 201301',
  },
];
...
async function main() {
  ...
  const subs = [
    ...
    },
    {
      ...
      mask: WEEKDAYS,
      start: addDays(today, -30),
      note: 'weekdays only — no order on Sat/Sun',
    },
    {
      n: 5,
      customer: 4,
      ...
      mask: ALL_DAYS,
      start: addDays(today, -30),
      note: 'PAUSED across today',
      pause: [yesterday, tomorrow],
    },
    {
      n: 6,
      customer: 5,
    ...
    },
    {
      ...
      mask: ALL_DAYS,
      start: addDays(today, -30),
      note: 'address changes tomorrow',
      addressChange: tomorrow,
    },
    {
      n: 8,
      customer: 1,
      ...
      note: 'starts next week — not servable yet',
    },
    {
      n: 9,
      customer: 2,
    ...
    const addressHistory = [
      {
        ...
        effective_from: s.start,
        recorded_at: new Date(Date.now() - 86_400_000 * 40).toISOString(),
      },
    ];
    if (s.addressChange) {
      addressHistory.push({
      ...
      ? [
          {
            from_date: s.pause[0],
            to_date: s.pause[1],
            recorded_at: new Date(Date.now() - 86_400_000 * 2).toISOString(),
          },
        ]
      : [];
    const skips = s.skip
